...
public class ValidateTemplates {
    ...
    private static final String templateFile = "/hzMessages.xml";
 
    @Test
    public void testFROMLoad() {
        
        String varName = "hzRequests";             
        assertTrue(FROMValidation.testForMatchingFROMs(templateFile, varName, FromFactory.hzRequests));
   ...
   public void testCodeGeneration() throws IOException, ParserConfigurationException, SAXException {
     ...
     //  FieldReferenceOffsetManager from = FromFactory.hzRequests;
